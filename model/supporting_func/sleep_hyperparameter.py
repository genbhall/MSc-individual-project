...
#input the dataframes for training and valid test
def model_distribution_tuning(df_train, df_valid, df_config, ground_truth, iteration=10):
    
    #get the models that we're testing
    model_params = df_config.to_numpy()
...
#input the dataframes for training and valid test
def final_distribution_tuning(df_train, df_valid, model_param, ground_truth, iteration=10):
    ...
    for i in range(iteration):
        ...
        log_file = open('hyperparam_logs/sleep/final_test_distribution.txt', 'a')
        ...
        #save the model parameters
        save_model(tgan, f"sleep/model_final_hh120/sleep_model_{i}.pickle")            
